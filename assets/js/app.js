...
var ContextMenu = React.createClass({
  ...
  getDefaultProps: function() {
    return {className:'ml-ui-box'};
  },

  render: function() {
    return React.DOM.div(this.props, 'Context Menu - continuar daqui!');
  }
});
ContextMenu = React.createFactory(ContextMenu);
...
// Render application.
ReactDOM.render(App(null), document.getElementById('overlay'));